...
public class Main_menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        choose_SETTINGS.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        panel_choose.setBackground(new java.awt.Color(27, 27, 20));
        panel_choose.setToolTipText("");

        panel_pos.setBackground(new java.awt.Color(243, 177, 0));
        panel_pos.setForeground(new java.awt.Color(243, 177, 0));

        chooose_POS.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        chooose_POS.setForeground(new java.awt.Color(255, 255, 255));
        ...
        chooose_POS.setText("Punto de Venta");
        ...
        panel_posLayout.setHorizontalGroup(
            ...
            .addComponent(chooose_POS, javax.swing.GroupLayout.DEFAULT_SIZE, 239, Short.MAX_VALUE)
        );
        ...
        panel_cos.setBackground(new java.awt.Color(243, 177, 0));

        choose_COSTUMER.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        choose_COSTUMER.setForeground(new java.awt.Color(255, 255, 255));
        ...
        choose_COSTUMER.setText("Cliente");
        ...
        panel_prod.setBackground(new java.awt.Color(243, 177, 0));

        choose_PRODUCT.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        choose_PRODUCT.setForeground(new java.awt.Color(255, 255, 255));
        ...
        choose_PRODUCT.setText("Productos");
        ...
        panel_income.setBackground(new java.awt.Color(243, 177, 0));

        choose_INCOME.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        choose_INCOME.setForeground(new java.awt.Color(255, 255, 255));
        ...
        choose_INCOME.setText("Ingresos");
        ...
        panel_invoice.setBackground(new java.awt.Color(243, 177, 0));

        choose_INVOICE.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        choose_INVOICE.setForeground(new java.awt.Color(255, 255, 255));
        ...
        choose_INVOICE.setText("Facturas");
        ...
        jPanel16.setBackground(new java.awt.Color(27, 27, 20));
        ...
        Panelhome.setBackground(new java.awt.Color(243, 177, 0));

        jLabel94.setBackground(new java.awt.Color(255, 255, 102));
        jLabel94.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        jLabel94.setForeground(new java.awt.Color(255, 255, 255));
        jLabel94.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel94.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/homeicon.png"))); // NOI18N
        jLabel94.setText("Inicio");
        ...
        jLabel94.addMouseWheelListener(new java.awt.event.MouseWheelListener() {
            public void mouseWheelMoved(java.awt.event.MouseWheelEvent evt) {
                jLabel94MouseWheelMoved(evt);
            }
        });
        ...
        Costumer.setBackground(new java.awt.Color(27, 27, 20));
        ...
        jPanel2.setBackground(new java.awt.Color(27, 27, 20));
        ...
        contact.setText("Numero Telefonico:");
        ...
        jPanel63.setBackground(new java.awt.Color(32, 32, 23));

        csearch.setBackground(new java.awt.Color(80, 75, 59));
        csearch.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        csearch.setForeground(new java.awt.Color(255, 255, 255));
        csearch.setText("Buscar por nombre o apellido");
        ...
        home.setBackground(new java.awt.Color(32, 32, 23));
        home.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel71.setBackground(new java.awt.Color(32, 32, 23));
        ...
        jPanel63Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel63Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(home, javax.swing.GroupLayout.PREFERRED_SIZE, 855, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanel63Layout.setVerticalGroup(
            ...
            .addGroup(jPanel63Layout.createSequentialGroup()
                ...
                .addGroup(jPanel63Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel63Layout.createSequentialGroup()
                        .addComponent(home, javax.swing.GroupLayout.PREFERRED_SIZE, 641, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))
        ...
        jPanel64.setBackground(new java.awt.Color(243, 177, 0));

        jTable1.setBackground(new java.awt.Color(243, 177, 0));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cliente ID", "Nombre", "Apellido", "Telefono", "Sexo", "Direccion", "Tiempo", "Fecha", "Email"
            }
        ) {
        ...
        panel_a.setBackground(new java.awt.Color(243, 177, 0));

        jLabel11.setBackground(new java.awt.Color(32, 32, 23));
        ...
        panel_s.setBackground(new java.awt.Color(243, 177, 0));
        ...
        panel_u.setBackground(new java.awt.Color(243, 177, 0));
        ...
        panel_d.setBackground(new java.awt.Color(243, 177, 0));
        ...
        panel_c.setBackground(new java.awt.Color(243, 177, 0));
        ...
        jPanel10.setBackground(new java.awt.Color(243, 177, 0));
        ...
        jPanel61.setBackground(new java.awt.Color(27, 27, 20));
        ...
        Costumer.add(jPanel61, new org.netbeans.lib.awtextra.AbsoluteConstraints(-60, 0, 850, 20));

        jPanel62.setBackground(new java.awt.Color(41, 49, 52));
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        ...
        try {
            ...
            if (costumerID.getText().isEmpty()) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Cambio Exitoso!!");
                OOP.clearupdate(costumerID, costumerName, costumerLastname, costumerNumber, costumerAddress, costumerSex, costumerEmail);
                costumerID.setText("");
                csearch.setText("Busca por nombre o apellido");
            }
        } catch (Exception ex) {
            System.out.println(ex.getMessage());
        }
    ...
    private void product_SAVEMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_product_SAVEMouseClicked
        ...
        try {
            ...
            if (product.getText().isEmpty() && bar_code.getText().isEmpty() && price.getText().isEmpty() && quantity.getText().isEmpty() && mark_up.getText().isEmpty() && exp_date.getText().isEmpty()) {
                ...
                JOptionPane.showMessageDialog(null, "Datos del cliente listo!!");
    ...
    private void product_UPDATEMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_product_UPDATEMouseClicked
        ...
        try {
            ...
            if (pid.getText().isEmpty()) {
                ...
                pid.setText("");
                psearch.setText("Buscar nombre producto");
                jComboBox1.setSelectedItem("Seleccionar producto");
            }
        } catch (Exception ex) {
            System.out.println(ex.getMessage());
        }
    ...
    private void product_DELETEMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_product_DELETEMouseClicked
        ...
        try {
            ...
            if (pid.getText().isEmpty()) {
                ...
                JOptionPane.showMessageDialog(null, "Eliminacion exitosa!!");
                OOP.clearupdate(product, bar_code, price, mark_up, exp_date, pid, quantity);
                psearch.setText("Buscar producto nombre");
            }
        } catch (Exception x) {
            System.out.println(x.getMessage());
        }
    ...
    private void product_REFRESHMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_product_REFRESHMouseClicked
        ...
        tab.setRowCount(0);
        OOP.clearupdate(product, bar_code, price, mark_up, exp_date, pid, quantity);
        psearch.setText("Busca nombre producto");
        data();
    ...
    private void psearchKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_psearchKeyPressed
        // TODO add your handling code here:
        if (psearch.getText().equals("Buscar producto nombre")) {
    ...
    private void chooose_POSMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_chooose_POSMouseClicked
        ...
        jComboBox2.setSelectedItem("Regular cliente");
        jComboBox1.setSelectedItem("Seleccionar producto");
    ...
    private void jLabel40MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel40MouseClicked
        ...
        if (product_id.getText().equals("0.0")) {
            ...
            JOptionPane.showMessageDialog(null, "seleccione cantidad");
        } else {
            try {
                mark_up();
                Statement state = Home_source.mycon().createStatement();
            ...
            jComboBox1.setSelectedItem("seleccione producto");
        }
        data();
        paid.setText("0.0");
        change.setText("0.0");
    ...
    private void jLabel94MouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_jLabel94MouseWheelMoved
        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel94MouseWheelMoved
