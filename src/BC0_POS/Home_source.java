...
public class Home_source {
    ...
    public void color(JPanel panel1) {
        panel1.setBackground(new Color(28, 30, 30));
    }

    public void empty(JLabel label, JLabel label1, JLabel label2, JLabel label3, JLabel label4, JLabel label5) {

        label.setText("Ingresa el nombre :"); 
        label1.setText("Ingresa el apellido :");
        label2.setText("Ingrese numero telef:");
        label3.setText("Ingrese sexo:");
        label4.setText("Ingrese Direccion:");
    ...
    public void settext1(JLabel label, JLabel label1, JLabel label2, JLabel label3, JLabel label4, JLabel label5) {
        ...
        label1.setText("Codigo de barra :");
        label2.setText("Precio :");
        label3.setText("Cantidad :");
        label4.setText("Ganancia :");
        label5.setText("Fecha de expiracion :");

    }

    public void empty1(JLabel label, JLabel label1, JLabel label2, JLabel label3, JLabel label4, JLabel label5) {

        label.setText("Ingrese nombre producto:");
        label1.setText("Ingrese codigo de barra:");
        label2.setText("Ingrese precio del producto:");
        label3.setText("Ingrese cantidad de producto :");
        label4.setText("Ingrese ganancia:");
        label5.setText("Ingrese fecha de expiracion:");
    }
    //Mysql Coonection
